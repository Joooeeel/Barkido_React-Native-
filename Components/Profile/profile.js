...
import { Container, Head, ButtonHead, Image, View, TopContainer, Button, Line, Text, Body, TopBody, InfoContainer, NameText, PhotosCampContainer, ViewContainer, CircleContainer, HumanImage, PhotoHumanView, ImageView } from './styled';
import PhotoCamp from './Photos/index';
            ...
            <Container>
                ...
                {animal.length > 0 &&
                    <Head source={{ uri: animal[0].photoPortada }}>
                        <View>
                            {/* <ButtonHead click={() => props.navigation.navigate("Edit Animal Profile")}> */}
                            <ButtonHead
                    ...
                    <TopBody>
                        {animal.length > 0 &&
                            <InfoContainer>
                                ...
                                {/* <Image source={ animal[0].sex == 'male'? <GenderImg source={male} />  :  <GenderImg source={female} /> } resizeMode='contain'></Image> */}


                                <Text>{animal[0].years + ' ' + 'Años'}  |  {animal[0].breed}</Text>
                                <Text />
                    ...
                    <PhotosCampContainer>
                        {
                            ...
                            publications.map((currentPublication, i) => <PhotoCamp key={i}
                                imageSource={currentPublication.photo}
                                navigation={navigation}
                                onPress={() => navigation.navigate('Open Profile', {
                                    user: user,
                                    animal: animal,
